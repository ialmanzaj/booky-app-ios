...
//		removeObservers()
//		NotificationCenter.default.addObserver(self, selector: #selector(saveReaderState), name: UIApplication.NSNotification.Name.UIApplicationWillResignActive, object: nil)
//		NotificationCenter.default.addObserver(self, selector: #selector(saveReaderState), name: UIApplication.NSNotification.Name.UIApplicationWillTerminate, object: nil)
//	}
//
//	/// Remove necessary observers
//	fileprivate func removeObservers() {
//		NotificationCenter.default.removeObserver(self, name: UIApplication.NSNotification.Name.UIApplicationWillResignActive, object: nil)
//		NotificationCenter.default.removeObserver(self, name: UIApplication.NSNotification.Name.UIApplicationWillTerminate, object: nil)
//	}
//}
...
//												   epubPath: epubPath, unzipPath: unzipPath, removeEpub: shouldRemoveEpub)
