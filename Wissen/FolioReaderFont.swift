...
//		let sun = UIImage(contentsOfFile: "icon-sun")
//		let moon = UIImage(contentsOfFile: "icon-moon")
//		let fontSmall = UIImage(contentsOfFile: "icon-font-small")
//		let fontBig = UIImage(contentsOfFile: "icon-font-big")
//		
